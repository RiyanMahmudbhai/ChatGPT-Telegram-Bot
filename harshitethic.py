...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6096779931:AAEYXbvqnxyBSzaMOqoZHLEgHl08tUR8I-k"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Lightning ChatGPT Bot'
username = 'lightning_chatgpt_bot'
